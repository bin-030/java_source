...
public class Ex35DtoTest1 {
	...
	// 3명의 학생 정보(학번, 이름, 점수)를 DTO에 저장하기
	...
	public void showData() {
		...
		System.out.println("첫번쨰 학생 정보 : " + list.get(0));
		System.out.println("두번쨰 학생 정보 : " + list.get(1));
		System.out.println("세번쨰 학생 정보 : " + list.get(2));
		System.out.println(list.get(2).getHakbun() + " " + 
							list.get(2).getIrum() + " " +
							list.get(2).getJumsu());
							
		System.out.println("\n--- 반복문을 사용해 컬렉션에 저장된 DTO의 내용 출력 ---");
		for(Ex35Student data:list) {	// 주소로 찍힘
