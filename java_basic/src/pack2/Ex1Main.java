...
public class Ex1Main {	// Ex1Main은 main 메소드를 실행하기 위한 클래스임.
	...
	public static void main(String[] args) {
		...
		/* Ex1Car 설계도로 객체를 생성. 이런 '객체를 인스턴스(instance)한다'라고 함.
		다시 말해 클래스로부터 객체를 만드는 과정을 '클래스의 인스턴스화'라고 하며,
		어떤 클래스로부터 만들어진 객체를 그 클래스의 인스턴스라고 한다. 
		객체는 모든 인스턴스를 대표하는 포괄적인 의미이다.
		클래스 -- 인스턴스화 --> 객체 */
		
		
		// Ex1Car.class를 주기억장로 읽은 후 car1 객체변수를 선언.
		...
		System.out.println();
		String ss = car1.driving();	// 변수로 기억
		ss = "와우 " + ss;
		System.out.println(ss);
		
		System.out.println(car1.driving());	// 일회성
		
		System.out.println();
		car1.drivingGood(2);	// 매개변수가 있는 메소드를 호출. 객체변수.메소드명(인자, 인수, argument)
