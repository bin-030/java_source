...
public class Ex5MainBank {
	...
	public static void main(String[] args) {
		...
		Ex5Bank james = null;
		System.out.println("james 객체 변수의 주소:" + james);	// null
		...
		ss2 = "kor";
		String ss3 = new String("kor");	// 값은 같지만 주소가 다름.
...
// 클래스의 주소를 치환하려면 클래스 타입이 같아야 함.
// 문자형 주소 비교는 equals 사용.